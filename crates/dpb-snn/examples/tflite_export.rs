...
fn export_quantized_int8() -> Result<(), String> {
    ...
    let config = TFLiteConfig::new("quantized_snn".to_string()).with_quantization(quant_config);
...
fn export_dynamic_quantization() -> Result<(), String> {
    ...
    let config = TFLiteConfig::new("dynamic_snn".to_string()).with_quantization(quant_config);
